...
import { Brand, GeoRakshakHeader } from "../components/GeoRakshakHeader";
...
export default function LandingPage() {
  ...
  return <main className="min-h-screen bg-cream font-body text-ink antialiased">
    <GeoRakshakHeader />
    <section id="home" className="scroll-mt-20 flex min-h-[92vh] items-center bg-[linear-gradient(180deg,rgba(10,20,15,0.42)_0%,rgba(10,20,15,0.62)_55%,rgba(9,17,13,0.88)_100%),url('/src/assets/bg.jpg')] bg-cover bg-[center_30%]"><div className="mx-auto max-w-[760px] px-8 py-[120px] text-center max-[520px]:px-5 max-[520px]:py-20"><span className="mb-7 inline-flex items-center gap-2 rounded-full border border-[rgba(201,138,60,0.5)] bg-[rgba(201,138,60,0.16)] px-4 py-[7px] text-[13.5px] font-medium text-cream"><span className="h-[7px] w-[7px] animate-pulse rounded-full bg-gold" />Live monitoring across the North Eastern Region</span><h1 className="font-display text-[clamp(32px,8vw,60px)] font-bold leading-[1.06] tracking-[-0.01em] text-white drop-shadow-[0_4px_24px_rgba(0,0,0,0.25)]">Protecting Lives.<br />Predicting Risks.</h1><p className="mx-auto mt-[22px] max-w-[480px] text-[clamp(15px,4vw,20px)] text-cream-dim">Any disaster? We are here to help!</p><div className="my-[38px] flex flex-wrap justify-center gap-4"><Link to="/signup" className="rounded-lg border border-gold bg-gold px-[30px] py-3.5 text-[15.5px] font-semibold text-[#1B1204] transition hover:-translate-y-px hover:bg-gold-dark w-full sm:w-auto text-center">Sign Up</Link><Link to="/login" className="rounded-lg border-[1.5px] border-[rgba(255,255,255,0.55)] bg-transparent px-[30px] py-3.5 text-[15.5px] font-semibold text-white transition hover:border-white hover:bg-[rgba(255,255,255,0.08)] w-full sm:w-auto text-center">Log In</Link></div><div className="mb-8"><Link to="/govt/login" className="inline-flex items-center gap-2 rounded-full border border-[rgba(74,222,128,0.45)] bg-[rgba(74,222,128,0.08)] px-5 py-2 text-[13.5px] font-semibold text-[#4ade80] transition-all hover:border-[#4ade80] hover:bg-[rgba(74,222,128,0.16)]"><span className="h-2 w-2 rounded-full bg-[#4ade80]" />Government Official Portal</Link></div><div className="inline-flex items-center gap-2.5 border-t border-[rgba(244,239,228,0.25)] pt-[22px] text-[15px] text-cream flex-wrap justify-center"><PhoneIcon /><span>Call for immediate assistance: <strong className="border-b border-gold pb-px font-semibold text-white"><a href="tel:0301234567">1078</a></strong></span></div></div></section>
